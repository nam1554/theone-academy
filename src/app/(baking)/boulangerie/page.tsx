...
import BoulangerieDeepening from "@containers/boulangerie/BoulangerieDeepening";
import BoulangerieIntroduction from "@containers/boulangerie/BoulangerieIntroduction";
          ...
          <div className="px-15pxr pt-30pxr pb-30pxr space-y-4">
            ...
            <div>
              <p className="text-12pxr text-center leading-6 md:text-18pxr md:leading-10">
                제빵자격증 취득 후 좀더 고급스러운 제빵을 배우실수 있는
                과정이며,
                <br />
                <br />
                카페 창업 이나 취업에 맞는 고급과정이며 맛있는 빵을 만들어보는
                클래스입니다.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row">
              <div className="flex justify-center items-center px-10pxr md:w-2/5 lg:w-1/2">
                <div className="relative w-full h-60 lg:h-[27rem]">
                  <Image
                    src="/images/boulangerie/boulangerie_menu_img_1.jpeg"
                    fill
                    sizes="100vw"
                    style={{
                      objectFit: "cover",
              ...
              <div className="p-15pxr flex flex-col justify-center space-y-5 divide-y divide-gray-400 md:grow lg:ml-30pxr">
                ...
                <div className="flex flex-col pt-20pxr space-y-7pxr">
                  <TextWithCheckIcon text="자격증 취득 후 스킬업을 하시는분들!" />
                  <TextWithCheckIcon text="나만의 카페 창업을 목표로 하시는분들" />
                  <TextWithCheckIcon text="맛있는 빵을 만들어 가족,친지분들께 행복한 경험을 선사해주실분!" />
                  <TextWithCheckIcon text="베이커리 종사자분중 제빵레시피가 필요하신분들" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-100 bg-opacity-80 py-30pxr md:py-100pxr">
          <div className="max-w-7xl mx-auto flex flex-col">
            <div className="md:mb-30pxr">
              <SubTitleBox
                title="블랑제리 입문"
                content={<>고급제빵과정 첫 입문단계 part.1</>}
                backgroundImageUrl="/images/boulangerie/boulangerie_menu_img_2.jpeg"
                titleClassName="text-theone-color9"
              />
            </div>
            <BoulangerieIntroduction />
          </div>
        </div>
      </section>
      <section>
          ...
          <div className="max-w-7xl mx-auto flex flex-col">
            <div className="md:mb-30pxr">
              <SubTitleBox
                ...
                backgroundImageUrl="/images/boulangerie/boulangerie_menu_img_3.jpeg"
                titleClassName="text-theone-color9"
              />
            </div>
            <BoulangerieDeepening />
          </div>
        </div>
      </section>
    </main>
